...
#define DEBUG_RED(x) ANSI_COLOR_RED << x << ANSI_COLOR_GREEN
#define DEBUG_GREEN(x) ANSI_COLOR_GREEN << x << ANSI_COLOR_GREEN
#define DEBUG_YELLOW(x) ANSI_COLOR_YELLOW << x << ANSI_COLOR_GREEN
#define DEBUG_BLUE(x) ANSI_COLOR_BLUE << x << ANSI_COLOR_GREEN
#define DEBUG_MAGENTA(x) ANSI_COLOR_MAGENTA << x << ANSI_COLOR_GREEN
#define DEBUG_CYAN(x) ANSI_COLOR_CYAN << x << ANSI_COLOR_GREEN
#define DEBUG_WHITE(x) ANSI_COLOR_WHITE << x << ANSI_COLOR_GREEN
